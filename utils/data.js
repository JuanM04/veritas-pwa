const staticData = require('utils/static-data.json')

const toModule = (day, ssmNumber, professor=false) => {
  const ssmInfo = staticData.ssm
  let newModule = {
    day,
...
module.exports = {
  classroom: [
    {
      ...
      professor_id: [ '03f9f864-9533-43d6-a246-7428fe025138' ],
      modules:      [ toModule('TUE',11), toModule('THU',12) ]
    },
    {
      subject_id:   '761649a3-6e76-4b92-935a-5ee145b0c02f',   // Matemáticas
      professor_id: [ 'e0e90739-79b5-421c-9672-a40b51883888' ],
  ...
  group2: [
    {
      ...
      professor_id: [ '218cd909-e85d-4904-b307-dbae8fa82cfb', '9109696b-b597-4e6e-b78e-7f7155563d49' ],
    ...
    },
    {
      ...
      professor_id: [ '1958b5a9-6fd4-47cd-b617-6169008258cd', '9109696b-b597-4e6e-b78e-7f7155563d49' ],
  ...
  group3: [
    {
      subject_id:   'b1875406-31ce-4d54-8f33-6731d27264f0',     // Instalación y Aplicación de la Energía
      professor_id: [ '218cd909-e85d-4904-b307-dbae8fa82cfb' ],
      modules:      [ toModule('MON',21), toModule('MON',22), toModule('MON',23), toModule('MON',24) ]
    },
    {
      subject_id:   'f5357a6b-2600-4b31-8346-9b09a9da5ebd',     // Dibujo Tecnológico
    ...
    {
      subject_id:   '547c2179-6a7a-40e2-a60e-85bfa3f35cfa',     // Dibujo y Procesamiento Mecánico
      professor_id: [ 'e69aab35-09f0-4cda-ba68-3e912593d433' ],
      modules:      [ toModule('WED',31), toModule('WED',32) ]
    },
    {
      subject_id:   'aa80aaba-25c3-436f-8937-0a180b4319b9',     // Máquinas Eléctricas I
      professor_id: [ '9109696b-b597-4e6e-b78e-7f7155563d49', '1958b5a9-6fd4-47cd-b617-6169008258cd' ],
  ...
  group7: [
    ...
    {
      subject_id:   'f5357a6b-2600-4b31-8346-9b09a9da5ebd',     // Dibujo Tecnológico
      professor_id: [ '70a0937d-64b1-42f1-9970-ea620ec0238a' ],
      modules:      [ toModule('THU',31) ]
    },
    {
      subject_id:   '547c2179-6a7a-40e2-a60e-85bfa3f35cfa',     // Dibujo y Procesamiento Mecánico
      professor_id: [ '25fc7b48-6ef7-4803-8632-a2449f6b3ccd', '61afd135-9502-407a-86d0-0dc74558b84d' ],
      modules:      [ toModule('WED',23,0), toModule('WED',24,0), toModule('FRI',23,1), toModule('FRI',24,1) ]
    },
    {
      subject_id:   'aa80aaba-25c3-436f-8937-0a180b4319b9',     // Máquinas Eléctricas I
      professor_id: [ '1958b5a9-6fd4-47cd-b617-6169008258cd', '00118229-2d0c-43b9-97e4-bc496fe3db5b' ],
